...
EFI_FLAGS=-ffreestanding -Ipath/to/gnu-efi/inc -I/home/espi/gnu-efi/inc/x86_64 -I/home/espi/gnu-efi/inc/protocol -c -o
EFI_OUTPUT_FLAGS=-nostdlib -Wl,-dll -shared -Wl,--subsystem,10 -e efi_main -o BOOTX64.EFI 
LD_FLAGS=-Tlink.ld
TMP_D=tmpd/
BUILD_D=build/
